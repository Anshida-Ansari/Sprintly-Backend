...
import { IStandupRepository } from "../interface/standup.interface";
...
export class StandupRepository extends BaseRepository<StandupEntity> implements IStandupRepository {
    ...
    async findUserStandupForDate(userId: string, sprintId: string, date: Date): Promise<StandupEntity | null> {
    ...
    async findBySprintAndDate(sprintId: string, date: Date): Promise<StandupEntity[]> {
