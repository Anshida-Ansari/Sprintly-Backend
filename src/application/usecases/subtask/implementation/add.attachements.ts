...
import { IAddAttachementsUseCase } from "../interface/add.attachements.interface";
...
export class AddAttachementes implements IAddAttachementsUseCase {
    ...
    async execute(subTaskId: string, fileUrl: string, fileName: string, uploadedBy: string): Promise<void> {
