...
} from "../interface/subscription.plan.usecases.interface.js";
	...
	implements ICreateSubscriptionPlanUseCase
{
	...
	async execute(
		data: Parameters<ICreateSubscriptionPlanUseCase["execute"]>["0"],
	...
	implements IUpdateSubscriptionPlanUseCase
{
	...
	async execute(
		id: string,
		data: Parameters<IUpdateSubscriptionPlanUseCase["execute"]>["1"],
	): Promise<SubscriptionPlanEntity> {
