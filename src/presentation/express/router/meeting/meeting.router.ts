...
import { MeetingController } from "../../../http/controllers/meeting.controller";
...
const meetingController = container.get<MeetingController>(MEETING_TYPES.MeetingController);
