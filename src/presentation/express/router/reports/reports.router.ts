...
router.get(REPORTS_ROUTES.SPRINTS, authorizeReports, (req, res, next) =>
	reportsController.getSprintReports(req, res, next),
);

router.get(REPORTS_ROUTES.USERSTORIES, authorizeReports, (req, res, next) =>
	reportsController.getUserStoryReports(req, res, next),
);

router.get(REPORTS_ROUTES.SUBTASKS, authorizeReports, (req, res, next) =>
	reportsController.getSubtaskReports(req, res, next),
);

router.get(REPORTS_ROUTES.PERFORMANCE, authorizeReports, (req, res, next) =>
	reportsController.getUserPerformanceReports(req, res, next),
);
