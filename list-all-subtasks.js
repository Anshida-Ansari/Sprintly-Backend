...
mongoose.connect(MONGO_URI).then(async () => {
    ...
    const SubtaskModel = mongoose.model('SubTask', new mongoose.Schema({}, { strict: false }), 'subtasks');
    ...
    allSubtasks.forEach((subtask, index) => {
        ...
        console.log(`  assignedTo: ${subtask._assignedTo || subtask.assignedTo || 'N/A'}`);
        console.log(`  userStoryId: ${subtask._userStoryId || subtask.userStoryId || 'N/A'}`);
        console.log('');
    });
